    ...
    <script>
        ...
        function initializeAOS() {
            ...
            if (anchoDisplay >= 768) { // Ajusta el ancho según tus necesidades
                ...
                // Desactiva AOS si el ancho de la pantalla es menor o igual a 768px
                AOS.init({
                    disable: true
                });
            }
        ...
        // Inicializa AOS al cargar la página
        initializeAOS();

        // Revisa el tamaño de la pantalla cuando se cambia el tamaño de la ventana
