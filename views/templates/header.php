...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="<?php echo is_auth() ? '/finalizar-registro' : '/registro'; ?>" class="navegacion__enlace <?php echo pagina_actual('/registro') ? 'navegacion__enlace--actual' : ''; ?>"><?php echo is_auth() ? 'Ver Pase' : 'Comprar Pase'; ?></a>
        </nav>
    </div>
</div>